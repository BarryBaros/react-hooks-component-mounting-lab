...
class App extends Component {
  ...
  render() {
    console.log("Rendering App with timers: ", this.state.timerIDs); // Debug log
  ...
  renderTimers = () => {
    const timers = this.state.timerIDs.map(id => {
      return <Timer key={id} id={id} removeTimer={this.removeTimer} />;
    });
    console.log("Rendering Timers: ", timers); // Debug log
    return timers;
  };
